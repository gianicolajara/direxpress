  ...
  return (
    ...
    >
      <div className="w-full h-full flex flex-col gap-y-4">
        <h2 className="font-extrabold text-3xl lg:text-5xl text-center mb-5 font-cabin">
          <span className="text-white">NUESTROS</span>{" "}
          <span className="text-red-app">VALORES</span>
          <br />
          <span className="text-white">CON IDENTIDAD PROPIA</span>
        </h2>
        <div className="w-full grid grid-cols-1 grid-rows-3 lg:grid-cols-3 lg:grid-rows-1 gap-5 lg:px-20 m-auto justify-items-center h-full lg:h-[400px]">
          <CardValues
